...
class PermissionAccount {
    ...
    async setVoterWeight(params) {
        ...
        const [realmSpawnRecord] = anchor.utils.publicKey.findProgramAddressSync([Buffer.from("RealmSpawnRecordAccountData"), governance.realm.toBytes()], this.program.programId);
